...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[800px] w-full mx-auto bg-blue min-h-screen">
        <div class="w-full min-h-screen flex flex-col items-center justify-center py-[46px] px-[28px] gap-8">
          <div class="succ rounded-[20px] overflow-hidden relative mx-1">
          ...
          <div class="flex flex-col gap-2 items-center text-center w-[319px] mx-auto">
            ...
            <p class="text-white">Thank you for trusting us <br> Don't Forget to check your scheduled page </p>
          </div>
