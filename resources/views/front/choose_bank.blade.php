...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[800px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-8">
      ...
      <div class="flex flex-1 flex-col h-full justify-center px-4 gap-8">
        <div class="px-[35px] justify-center md:w-full flex shrink-0">
