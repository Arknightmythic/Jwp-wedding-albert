...
<body class="font-poppins text-black">
    @if($errors->any())
                        ...
                        @endforeach
                    @endif
    <section id="content" class="max-w-[800px] w-full mx-auto bg-[#F9F2EF] min-h-screen">
        <div class="w-full min-h-screen dis items-center justify-center py-[46px] px-4 gap-8">
          <div class="w-[calc(100%-26px)] rounded-[20px] overflow-hidden relative flex justify-center">
            <img src="assets/backgrounds/Asset-signup.png" class="w-1/2 md:w-full h-full object-contain" alt="background">
          </div>
