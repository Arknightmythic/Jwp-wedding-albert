            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{Storage::url($booking->wedding->thumbnail)}}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]">
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">{{$booking->wedding->name}}</h3>
                        <p class="text-slate-500 text-sm"></p>{{$booking->wedding->category->name}}
                        </div>
                    </div> 
                        @if($booking->is_paid)
                    ...
                    <div  class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{$booking->wedding->pax * $booking->quantity}} pax</h3>
                    </div>
                    <div  class="hidden md:flex flex-col">
