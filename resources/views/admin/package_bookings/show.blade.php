            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{Storage::url($packageBooking->wedding->thumbnail)}}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]">
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">{{$packageBooking->wedding->name}}</h3>
                        <p class="text-slate-500 text-sm">{{$packageBooking->wedding->category->name}}</p>
                        </div>
                    </div> 
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col gap-y-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{$packageBooking->wedding->pax *$packageBooking->quantity }} pax
                            </h3>
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{$packageBooking->wedding_date->format('d M y')}}
                            </h3>
                        </div>
