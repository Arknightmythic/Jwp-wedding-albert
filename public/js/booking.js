function calculatePrice(){
    ...
    let packageWeddingPrice = parseInt(document.getElementById('packageWeddingPrice').value);
    let insurance = 300000;
    let taxRate = 0.10; // Assuming a tax rate of 10%

    const weddingPrice = packageWeddingPrice;
    subTotal = weddingPrice * quantity;
